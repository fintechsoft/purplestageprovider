...
class CustomDropDownButton extends StatefulWidget {
  ...
  const CustomDropDownButton({super.key,required this.itemList,required this.type, required this.title,});
  @override
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DashboardController>(builder: (dashboardController){
      return CustomDropDown(
          type: widget.title,
          hint:  widget.type == "Year"? dashboardController.selectedYear : dashboardController.selectedMonth.tr,
          errorText: '',
