      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Column(children: [
            ...
            Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Flexible(
                  child: Text(selectedPackage.name?.tr ?? "" , style: ubuntuMedium.copyWith(
            ...
            Text( selectedPackage.id == "0" ? "${selectedPackage.price?.toStringAsFixed(0)} %" : PriceConverter.convertPrice(selectedPackage.price ?? 0), style: ubuntuBold.copyWith(
              color: isSelected ? Colors.white : Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge,
            )),
            Text(selectedPackage.duration !=null ? "${selectedPackage.duration ?? ""} ${"days".tr}" : "", style: ubuntuRegular.copyWith(
        ...
        selectedPackage.id == "0"  ? Padding(
          ...
          child: Text(selectedPackage.description ?? "",
            style: ubuntuRegular.copyWith(color: isSelected ? Colors.white : Theme.of(context).primaryColor,),
          ...
          children: selectedPackage.featureList!.map((element){
            ...
            return Padding(padding: const EdgeInsets.symmetric(vertical: 3, horizontal: Dimensions.paddingSizeLarge),
              child: Text("• ${(element == "booking" || element == "category") && limit == null ? "unlimited".tr : limit ?? ""} "
                  "${(element == "category") ? "subcategory's_subscription".tr : element.tr}", style: ubuntuRegular.copyWith(
                color: isSelected ? Colors.white : Theme.of(context).primaryColor,
              ),
                textAlign: TextAlign.center,
              ),
