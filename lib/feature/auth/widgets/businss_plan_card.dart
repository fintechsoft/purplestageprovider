            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  title !=null ? Flexible(child: Text(title!.tr, style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeLarge, overflow: TextOverflow.ellipsis),)) : const SizedBox()
                ]),

                const SizedBox(height: Dimensions.paddingSizeDefault,),

                subtitle !=null ? Text(subtitle!.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).hintColor),) : const SizedBox()
              ]),
            ),
