...
class CameraButtonSheet extends StatelessWidget {
  ...
  const CameraButtonSheet({super.key, required this.bookingId});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text("submit_service_proof".tr , style: ubuntuBold.copyWith(
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          InkWell(
            ...
            child: Column(children: [
              ...
              Text('upload_image'.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(0.7))),
            ]),
          ),
          ...
          InkWell(
            ...
            child: Column(children: [
              ...
              Text('take_photo'.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(0.7)))
            ]),
          ),
          const SizedBox(),
        ]),
