...
class CartServiceWidget extends StatelessWidget {
  ...
  const CartServiceWidget({
    super.key,
    required this.cart,
    required this.cartIndex, required this.disableQuantityButton,
  });
      ...
      return Container(
        ...
        child: Stack(alignment: Alignment.center, clipBehavior: Clip.antiAliasWithSaveLayer, children: [
          ...
          Dismissible(key: UniqueKey(),
            ...
            child: CartItemView(bookingEditController: bookingEditController, cart: cart, cartIndex: cartIndex, disableQuantityButton: disableQuantityButton,),
          ) : CartItemView(bookingEditController: bookingEditController, cart: cart, cartIndex: cartIndex, disableQuantityButton: disableQuantityButton,),
...
class CartItemView extends StatelessWidget {
  ...
  final int cartIndex;
  final bool disableQuantityButton;
  const CartItemView({super.key, required this.bookingEditController, this.cart, required this.cartIndex, required this.disableQuantityButton});
