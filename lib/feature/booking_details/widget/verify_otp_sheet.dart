...
class OtpVerificationBottomSheet extends StatefulWidget {
  ...
  const OtpVerificationBottomSheet({super.key, this.bookingId});
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Column(children: [
              ...
              Text('wrong_otp_number'.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).colorScheme.error), textAlign: TextAlign.center) :
              !bookingDetailsController.isWrongOtpSubmitted  && !bookingDetailsController.isStatusUpdateLoading ? Text('collect_otp_from_customer'.tr, style: ubuntuRegular, textAlign: TextAlign.center):
              const Text(""),
              const SizedBox(height: Dimensions.paddingSizeLarge),
            ...
            CustomButton(
              ...
              onPressed: (bookingDetailsController.otp.length != 6) ? null : () async {
               ...
               await bookingDetailsController.changeBookingStatus( widget.bookingId ?? "", bookingStatus :"completed" ,isBack: true);
               },
            ),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              bookingDetailsController.hideResendButton ?  Padding(
                ...
                child: Text(
                  'resend_it'.tr,
                  style: ubuntuMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault),
                ),
              )
            ]),
