...
class ServiceCompletedPhotoEvidence extends StatelessWidget {
  const ServiceCompletedPhotoEvidence({super.key});
        ...
        child: Column(children: [
          ...
          Get.find<SplashController>().configModel.content?.bookingImageVerification == 1 && showDeliveryConfirmImage && bookingDetails.bookingStatus != 'completed' ? Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if(index < 5 && index == bookingDetailsController.pickedPhotoEvidence.length) {
                      return InkWell(
                        onTap: () {
                          showCustomBottomSheet(child: CameraButtonSheet(bookingId: bookingDetails.id!,));
                        },
                        child: Container(
              ...
              Text('you_can_upload_max_5_picture'.tr,  style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),),
            ]),
          ) : const SizedBox(),
