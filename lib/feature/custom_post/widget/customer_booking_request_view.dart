                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                      Text("${postData.customer?.firstName??""} ${postData.customer?.lastName??""}",
                          style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.7)),
                          maxLines: 1, overflow: TextOverflow.ellipsis),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                      Text("${postData.distance??"0 km"} ${'away_from_you'.tr}",style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall,
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,children: [
                        Text(postData.service?.name??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.7)),
                            maxLines: 1, overflow: TextOverflow.ellipsis),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall-2),
                        Text(postData.subCategory?.name??"",style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text(
                          postController.tabController!.index==0?'place_offer'.tr:'withdraw_request'.tr, style: ubuntuRegular.copyWith(
