                          ...
                          children: [
                            Center(child: Column(children: [
                              Padding( padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraLarge),
                                child: Text("new_booking_request_from".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                              ...
                              Text("${postData?.distance??"0 km"} ${'away_from_you'.tr}", style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8))
                              ),
                            ])),
                          ],
                        ),
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(postData?.service?.name??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis,),
                                Text(postData?.subCategory?.name??"",
                                  style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8)), maxLines: 1, overflow: TextOverflow.ellipsis,
                                ),
                              ],
                            ),
                          )
