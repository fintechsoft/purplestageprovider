...
import 'package:purplestage_provider/feature/custom_post/model/post_model.dart';
        ...
        return GestureDetector(
          ...
          child: SingleChildScrollView(child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                  ...
                  Center(child: Column(children: [
                    Padding( padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraLarge),
                      child: Row(mainAxisAlignment: MainAxisAlignment.center,children: [
                        Text("new_booking_request_from".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ...
                    Text("${widget.postData.distance??"0 km"} ${'away_from_you'.tr}", style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8))
                    ),
                  ])),
                  if(postController.showInfoWidget)
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(widget.postData.service?.name??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,), textAlign: TextAlign.justify,),
                      Text(widget.postData.subCategory?.name??"",
                          style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8))),
                    ],),
                )
              ],
              ),
              ...
              Text("additional_instruction".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).secondaryHeaderColor),
                maxLines: 1, overflow: TextOverflow.ellipsis,),
              ...
              ListView.builder(itemBuilder: (context,index){
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: Text(widget.postData.additionInstructions![index].details??"",style: ubuntuRegular.copyWith(color: Theme.of(context).primaryColor,fontSize: Dimensions.fontSizeDefault),),
                  ),
                );
      ...
      Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(height: 45,decoration: BoxDecoration(
            ...
            child: Center(child: Text("see_other_provider_offers".tr,style: ubuntuRegular.copyWith(
