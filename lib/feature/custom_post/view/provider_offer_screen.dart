                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(widget.postData.service?.name??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,), maxLines: 1, overflow: TextOverflow.ellipsis,),
                          Text(widget.postData.subCategory?.name??"",  style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8)),maxLines: 1, overflow: TextOverflow.ellipsis,),
                        ],),
                    )
                  ],
                  ),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Padding( padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                    child: Text('not_interested'.tr, style: ubuntuMedium.copyWith(
