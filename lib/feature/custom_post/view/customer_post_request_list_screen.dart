...
import 'package:purplestage_provider/feature/custom_post/widget/custom_post_list_view.dart';
            ...
            children: [
              Container(
                ...
                child: TabBar(
                  ...
                  tabs:  [
                    SizedBox(height: 45, child:Center(child: Text("new_request".tr,style: ubuntuMedium,))),
                    SizedBox(height: 45, child:  Center(child: Text("my_bids".tr,style: ubuntuMedium,))),
                  ],
