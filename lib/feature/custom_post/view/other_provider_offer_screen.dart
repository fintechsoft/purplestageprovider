...
import 'package:purplestage_provider/feature/custom_post/widget/others_provider_offer_list_screen.dart';
    ...
    return GetBuilder<PostController>(builder: (postController){
      return Container(
        ...
        child: Column(children: [
          ...
          Text("others_provider_offer".tr,style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),),
