          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(amount,style: ubuntuBold.copyWith(color: amountTextColor,fontSize: Dimensions.fontSizeLarge + 2
                  ),),
                  Text(title,style: ubuntuMedium.copyWith(fontSize: width> 400 ? 14 : 13, overflow: TextOverflow.ellipsis)),
                ],
              ),
            )
          ],
