      ...
      return Stack(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              "$totalBookingRequest\n${'booking'.tr}",
              textAlign: TextAlign.center,style: ubuntuBold.copyWith(color: Theme.of(context).primaryColor,fontSize: 14),
            ),
          )
        ],
      );
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            radius: radius,
            titleStyle: ubuntuMedium.copyWith(color: Colors.white),
          );
        case 1:
          return PieChartSectionData(
