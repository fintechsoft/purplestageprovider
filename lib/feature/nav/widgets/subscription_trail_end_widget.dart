          ...
          Container(
            ...
            child: InkWell(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.end, children: [
                    ...
                    return Stack(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height: 18, width: 18,
                          child: FittedBox(
                            child: Text( "$trialRemainDuration", style: ubuntuBold.copyWith(
                              color: Colors.white,
                            ),),
                          ),
                        ),
                ...
                ) : Text("${'free_trial'.tr}\n${'will_be_end_today'.tr}", style: ubuntuRegular.copyWith(
                      ...
                      (value > 0.40) ? InkWell(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(children: [
                              Text( "choose_plan".tr, style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
