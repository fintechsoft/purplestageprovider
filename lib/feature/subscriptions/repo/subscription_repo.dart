...
class SubscriptionRepo{
  ...
  Future<Response> getSubcategorySubscriptionList(int offset) async {
    return await apiClient.getData("${AppConstants.subscriptionListUrl}?limit=${Get.find<SplashController>().configModel.content?.paginationLimit}&offset=$offset");
  }
