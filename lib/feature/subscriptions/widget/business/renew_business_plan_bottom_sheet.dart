              ...
              ConstrainedBox(
                ...
                child: SingleChildScrollView(
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text( widget.packageStatus == "renew" ? 'renew_business_plan'.tr : 'shift_to_new_business_plan'.tr, style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            ...
                            Positioned(
                              ...
                              child: Column(children: [
                                ...
                                Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                  child: Text(widget.activePackage?.name?.tr ?? '', style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.cyan.shade700,), textAlign: TextAlign.center,maxLines: 1, overflow: TextOverflow.ellipsis,),
                                ),
                                const SizedBox(height: Dimensions.paddingSizeDefault,),
                                Text(widget.activePackage?.id ==  "0" ? "${widget.activePackage?.price?.toStringAsFixed(0)} %" : PriceConverter.convertPrice(widget.activePackage?.price ?? 0),
                                  style: ubuntuBold.copyWith(fontSize: 25, color:  Colors.cyan.shade700),
                                ),

                                Text(widget.activePackage?.id ==  "0" ? "" : '${widget.activePackage?.duration} ' 'days'.tr, style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                const SizedBox(height: Dimensions.paddingSizeDefault),
                        ...
                        widget.packageStatus == "renew"  ? Stack(children: [
                          ...
                          Positioned(
                            ...
                            child: Column(children: [
                              ...
                              Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                child: Text(widget.selectedPackage.name?.tr ?? '', style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).cardColor), textAlign: TextAlign.center,maxLines: 1, overflow: TextOverflow.ellipsis,),
                              ),
                              const SizedBox(height: Dimensions.paddingSizeDefault,),
                              Text(widget.selectedPackage.id ==  "0" ? "${widget.selectedPackage.price?.toStringAsFixed(0)} %" : PriceConverter.convertPrice(widget.selectedPackage.price ?? 0),
                                style: ubuntuBold.copyWith(fontSize: 25,  color: Theme.of(context).cardColor),
                              ),

                              Text(widget.selectedPackage.id ==  "0" ? "" : '${widget.selectedPackage.duration} ' 'days'.tr, style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                              const SizedBox(height: Dimensions.paddingSizeDefault),
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                            Text('validity'.tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            Text('${widget.selectedPackage.duration} ' 'days'.tr, style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge,), maxLines: 1, overflow: TextOverflow.ellipsis,),
                          ]),
                        ),

                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                            Text('price'.tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            Text(PriceConverter.convertPrice(widget.selectedPackage.price), style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                          ]),
                        ),

                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                            Text('bill_status'.tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            Text(widget.packageStatus == "renew"  ? 'renew'.tr : 'migrate'.tr, style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                          ]),
                        ),
                    ...
                    widget.selectedPackage.name == "commission_base" && widget.selectedPackage.id == "0" ? const SizedBox() : paymentMethodList.isNotEmpty ? Container(
                      ...
                      child: Text("no_payment_method_available".tr, style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color),),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
