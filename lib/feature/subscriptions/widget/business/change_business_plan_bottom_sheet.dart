...
class _ChangeBusinessPlanBottomSheetState extends State<ChangeBusinessPlanBottomSheet> {
  ...
  void initState() {
    ...
    subscriptionPackagesList?.removeWhere((element) => element.id == "0");
     ...
     if(subscriptionPackagesList!.isNotEmpty && (subscriptionPackagesList?.first.id != "0" && widget.showCommissionCard) || (subscriptionPackagesList!.isEmpty && widget.showCommissionCard)){
          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              subscriptionPackagesList !=null && subscriptionPackagesList!.isNotEmpty? SingleChildScrollView(
                ...
                child: Text('no_subscription_plan_available_at_this_moment'.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).hintColor),),
              ),
