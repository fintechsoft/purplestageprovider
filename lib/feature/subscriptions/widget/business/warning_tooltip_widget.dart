        ...
        child: Column(
          ...
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('attention'.tr, style: ubuntuBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeLarge),),
            ...
            Text(
              ...
              style: ubuntuRegular.copyWith(color: Colors.white.withOpacity(0.85)),
            ),
          ],
        ),
      ),
