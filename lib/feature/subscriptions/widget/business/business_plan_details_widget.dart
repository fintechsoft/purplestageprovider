import 'package:purplestage_provider/common/widgets/custom_bottom_sheet_widget.dart';
                ...
                Expanded(child: SingleChildScrollView(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                      Text("billing_details".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),),
                    ...
                    Row(children: [
                      Text("package_overview".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),),
                      ...
                      (!isPaid && !isFreeTrial) ? Container(
                        ...
                        child: Text('unpaid'.tr, style: ubuntuMedium.copyWith(color: Colors.white)),
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: 5),
                        child: Text('expired'.tr, style: ubuntuMedium.copyWith(color: Colors.white)),
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: 5),
                        child: Text('canceled'.tr, style: ubuntuMedium.copyWith(color: Colors.white)),
                      ) : const SizedBox(),
                    ...
                    Container(
                      ...
                      child: Column( crossAxisAlignment: CrossAxisAlignment.start , children: [
                        ...
                        ListTile(
                          title: Text(subscriptionInfo?.renewalPackageDetails?.name ?? "", style: ubuntuBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge),),
                          subtitle: Text(subscriptionInfo?.renewalPackageDetails?.description ?? "",
                            style: ubuntuRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeDefault),
                            maxLines: 5, overflow: TextOverflow.ellipsis,
                          ),
                          trailing: RichText(
                            text: TextSpan(
                              children: <TextSpan>[
                                TextSpan(text: PriceConverter.convertPrice((subscriptionInfo?.subscribedPackageDetails?.packagePrice ?? 0) - (subscriptionInfo?.subscribedPackageDetails?.vatAmount ?? 0)),style: ubuntuBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeLarge)),
                                TextSpan(text: " / ", style: ubuntuBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeLarge)),
                                TextSpan(text: "$duration ${'days'.tr}", style: ubuntuLight.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeDefault)),
                              ],
                            ),
                          ),
                        ),
...
class BillingDetailsItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(title?.tr ?? "", style: ubuntuMedium.copyWith(color: Theme.of(context).hintColor.withOpacity(0.7), fontSize: Dimensions.fontSizeDefault),),
      subtitle: Text(subTitle?.tr ?? "", style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge),),
    );
  }
}
        ...
        text: TextSpan(
          children: <TextSpan>[
           TextSpan(text: "${(title == "booking" || title == "category") && limit == null ? "unlimited".tr : limit ?? ""}"
             ...
             style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color, fontSize: Dimensions.fontSizeDefault),
           ),
            const TextSpan(text: "  "),
            if(subTitle !=null) TextSpan(text: "($subTitle ${'left'.tr} )" , style: ubuntuLight.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
          ],
        ),
      ),
    );
