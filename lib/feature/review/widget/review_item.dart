    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
          onTap: () => Get.toNamed(RouteHelper.getBookingDetailsRoute(review.bookingId!, "", "others")),
          child: Padding(
                ...
                child: Row( children: [
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        Text('review_id'.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).primaryColor),),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                        Expanded(child: Text('${(review.readableId !=null && review.readableId !=0) ? review.readableId  : "N/A"}', style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color), overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ) ,
                          ...
                          children: [
                            Flexible(
                              child: Text("${review.customer?.firstName ?? ""} ${review.customer?.lastName ?? ""}",
                                style: ubuntuMedium.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(1)),
                            ...
                            Text(review.reviewRating!.toString(),
                              style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),
                            ),
