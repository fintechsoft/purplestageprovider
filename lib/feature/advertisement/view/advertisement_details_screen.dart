                ...
                return SingleChildScrollView(child: Column(children: [
                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text("service_info".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,)),
                      ...
                      Text("video".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,)): const SizedBox(),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall,),
                        ...
                        child: Row(children: [
                          ...
                          Expanded(flex: 2,
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text("logo/profile".tr, style: ubuntuBold, maxLines: 1, overflow: TextOverflow.ellipsis),
                          ...
                          Expanded(flex: 3, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text("cover".tr, style: ubuntuBold),
