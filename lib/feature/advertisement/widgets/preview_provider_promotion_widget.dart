        ...
        child: Container(
          ...
          child:  Column(mainAxisSize:  MainAxisSize.min, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text("template_preview".tr, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault),),
              InkWell(
                onTap: ()=> Get.back(),
                    ...
                    child: Row( children: [
                      ...
                      Expanded(
                        child: Column( crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          ): Text(description!, maxLines: 2, overflow: TextOverflow.ellipsis, style: ubuntuRegular.copyWith(
