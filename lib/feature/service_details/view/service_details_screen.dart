                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          Column(
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                ...
                                Text("start_form".tr, style: ubuntuRegular.copyWith(
          ...
          return Padding(padding: const EdgeInsets.symmetric(
              ...
              child: Container(
                ...
                child: TabBar(
                  ...
                  unselectedLabelStyle: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                  labelStyle: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeDefault),
                  onTap: (int? index) {
                    switch (index) {
