                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  Row(mainAxisSize: MainAxisSize.min, children: [
                    Text(PriceConverter.convertPrice(transactionAmount),
                      style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeOverLarge - 3, color: Theme.of(context).primaryColor),
                    ),
                    ...
                    JustTheTooltip(
                      ...
                      content: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeSmall),
                        child: Text('${'maximum_cash_in_hand_amount'.tr} ${PriceConverter.convertPrice(Get.find<SplashController>().configModel.content?.maxCashInHandLimit??0)}',style: ubuntuRegular.copyWith(color: Colors.white70),),
                      ),
                      child: InkWell(
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault -1, color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8)),
                      children: payablePercent >= 100 ? <TextSpan>[
                        TextSpan(
                          text: 'limit_exceed'.tr,
                          style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).colorScheme.error),
                        ) ,
                      ] : [],
                    ),
                  ),
