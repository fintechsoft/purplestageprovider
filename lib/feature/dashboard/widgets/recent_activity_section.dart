import 'package:purplestage_provider/feature/dashboard/widgets/recent_activity_graph.dart';
import 'package:purplestage_provider/feature/dashboard/widgets/recent_activity_list_view.dart';
              ...
              children: [
                Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall, vertical: Dimensions.paddingSizeSmall),
                  child: TabBar(
                    ...
                    tabs:  [
                      SizedBox(height: 35, child:Center(child: Text("normal_booking".tr, style: ubuntuMedium,)),),
                      SizedBox(height: 35, child:  Center(child: Text("customised_booking".tr, style: ubuntuMedium,)),
                      ),
                    ],
                    onTap: (index){
