            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,children: [
                  Text(dashboardController.dashboardCustomizedPostList[index].service?.name??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.7)),
                      maxLines: 1, overflow: TextOverflow.ellipsis),
                  Text(dashboardController.dashboardCustomizedPostList[index].subCategory?.name??"",style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('place_offer'.tr, style: ubuntuRegular.copyWith(
