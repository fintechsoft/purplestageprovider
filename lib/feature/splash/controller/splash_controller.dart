...
class SplashController extends GetxController implements GetxService {
  ...
  Future<bool> getConfigData() async {
    ...
    if(response.statusCode == 200) {
      //String onne = response.body;
      // int chunkSize = 1000; // Adjust chunk size as needed for your console
      // for (int i = 0; i < onne.length; i += chunkSize) {
      //   print(onne.substring(i, i + chunkSize > onne.length ? onne.length : i + chunkSize));
      // }
