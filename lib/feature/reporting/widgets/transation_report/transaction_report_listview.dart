...
import 'package:purplestage_provider/feature/reporting/model/transaction_report_model.dart';
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault,),
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween , children: [
                        Text(transactionReportList[index].trxType.toString().tr,
                          style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.labelLarge?.color),
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: ubuntuRegular.copyWith(color:  Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8)),
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                      ],),
                    ...
                    Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(PriceConverter.convertPrice(transactionReportList[index].debit), style: ubuntuRegular),
                      ],),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall,),
                    ...
                    Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(PriceConverter.convertPrice(transactionReportList[index].credit), style: ubuntuRegular),
                      ],),
                    ),
                    ...
                    Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('balance'.tr, style: ubuntuRegular.copyWith(color: Theme.of(context).hintColor)),
                        Text(PriceConverter.convertPrice(transactionReportList[index].balance), style: ubuntuRegular),
                      ],),
                    ),
                  ],),
                );
