      ...
      return Padding(padding: const EdgeInsets.symmetric(
        ...
        child: Shimmer(duration: const Duration(seconds: 2), child: Container(
          ...
          child:  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(padding: const EdgeInsets.symmetric(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Column( crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(height: Dimensions.paddingSizeExtraLarge + 5, width: 150,
                    decoration: BoxDecoration(
                  ...
                  Container(height: Dimensions.paddingSizeDefault, width: 200,
                    decoration: BoxDecoration(
                        color: Get.isDarkMode? Colors.grey.shade700 : Colors.grey.shade100,
                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault)
                    ),
                ...
                Container(height: Dimensions.paddingSizeExtraLarge + 5, width: 80,
                  decoration: BoxDecoration(
            ...
            Divider(height: 2, thickness: 3, color: Theme.of(context).primaryColor.withOpacity(0.04)),
            ...
            Padding(padding: const EdgeInsets.symmetric(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Column( crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(height: Dimensions.paddingSizeLarge, width: 150,
                    decoration: BoxDecoration(
                        color: Get.isDarkMode? Colors.grey.shade700 : Colors.grey.shade100,
                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault)
                    ),
                  ...
                  Container(height: Dimensions.paddingSizeLarge, width: 140,
                    decoration: BoxDecoration(
                        color: Get.isDarkMode? Colors.grey.shade700 : Colors.grey.shade100,
                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault)
                    ),
