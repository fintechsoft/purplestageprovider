...
class EventCreatedSuccessfullySheet extends StatelessWidget {
  const EventCreatedSuccessfullySheet({super.key});
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Image.asset(Images.addEventSuccessfulIcon, height: 130, fit: BoxFit.fitHeight,),
