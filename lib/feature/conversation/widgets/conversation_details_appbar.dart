    ...
    return AppBar(
      ...
      title: Row( children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text( name?.tr ?? "", style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault,
            color: Get.isDarkMode ? Theme.of(context).hintColor : Colors.black,
          )),

          if(phone !="") Text(phone ?? "", style: ubuntuLight.copyWith( fontSize: Dimensions.fontSizeSmall,
