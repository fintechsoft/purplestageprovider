                ...
                builder: (controller) => Column(children: [
                  Stack(children: [
                    Column(
                      ...
                      Row(
                        children: [
                          Text("available_balance".tr,style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)),),
                        ...
                        Row(
                          children: [
                            Text("minimum_withdraw_amount".tr,style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)),),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                        ...
                        Row(
                          children: [
                            Text("maximum_withdraw_amount".tr,style: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)),),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
