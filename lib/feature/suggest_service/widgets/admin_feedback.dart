            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("admin_feedback".tr,style: ubuntuMedium.copyWith(color: Theme.of(context).
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${"category_name".tr} : ",style: ubuntuRegular.copyWith(color: Theme.of(context).
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${"service_name".tr} : ",style: ubuntuRegular.copyWith(color: Theme.of(context).
                        textTheme.bodyLarge!.color!.withOpacity(0.8) ,
                          fontSize: Dimensions.fontSizeDefault,
                        )),

                        Flexible(
                          child: Text(controller.suggestedServiceList[index].serviceName??"",style: ubuntuRegular.copyWith(color: Theme.of(context).
                          textTheme.bodyLarge!.color!.withOpacity(0.5) ,
                            fontSize: Dimensions.fontSizeDefault,
                          )),
                        ),
