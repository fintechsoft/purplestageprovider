...
import 'package:purplestage_provider/feature/suggest_service/widgets/suggest_service_item_view.dart';
import 'package:purplestage_provider/feature/suggest_service/widgets/suggest_service_list_shimmer.dart';
              ...
              child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,children: [
                  Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
                    child: Text('${'request'.tr} (${suggestServiceController.suggestedServiceList.length})',style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeLarge),),
                  ),
