import 'package:purplestage_provider/common/model/language_model.dart';
import 'package:purplestage_provider/utils/images.dart';

class AppConstants {

  static const String appName = 'PurpleStage Artist Partner';
  static const String appUser = 'Artist App';
  static const String appVersion = '2.9';
  static const String baseUrl = 'https://artist.purplestage.in';
  ...
  static const String providerArtisticUri = '/api/v1/provider/account/artistic';
  static const String providerProfileUpdateUrl = '/api/v1/provider/update/profile';
  static const String providerArtisticUpdateUrl = '/api/v1/provider/update/artistic';
  ...
  static const String changeBookingStatusUrl = '/api/v1/provider/booking/status-update';
  ...
  static const String updateBooking = '/api/v1/provider/booking/service/edit/update-booking';
  ...
  static const String submitNewEvent = '/api/v1/provider/event/store';
  static const String editEvent = '/api/v1/provider/event/update';
  static const String getEventList = '/api/v1/provider/event';
  static const String getEventDetails = '/api/v1/provider/event/details';
  static const String deleteEvent = '/api/v1/provider/event/delete';
  static const String changeEventStatus ='/api/v1/provider/event/status-update';
  static const String reSubmitEvent = '/api/v1/provider/event/store-re-submit';
  ...
  static const String invoiceUrl = "/admin/booking/provider-invoice/";
