...
class DateConverter {
  ...
  static DateTime isoUtcStringToLocalDatee(String dateTime) {
    return DateFormat('yyyy-MM-dd HH:mm:ss').parse(dateTime, true).toLocal();
  }

  static DateTime isoUtcStringToLocalDateevent(String dateTime) {
    return DateFormat('yyyy-MM-dd HH:mm:ss').parse(dateTime, true).toLocal();
  }
  ...
  static String dateStringMonthYear(DateTime ? dateTime) {
    return _localDateFormatter('d MMM,y').format(dateTime ?? DateTime.now());
  }
